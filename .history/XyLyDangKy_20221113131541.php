...
if(isset($_POST['sub']))
{
    ...
    echo $role='U'  ;
    $sql= "INSERT into khachhang (`MaKhachHang`, `TenKhachHang`, `Email`, `TaiKhoan`, `MatKhau`, `SoDienThoai`, `DiaChi`, `RoleID`) values (null,$tenkh, $email, $taikhoan, $pass, $_POSTsdt, :diachi, 'U')";
    $connect->exec($sql);
