...
if(isset($_POST['sub']))
{
    ...
    echo $role='U'  ;
    $sql= "INSERT INTO `khachhang` (`MaKhachHang`, `TenKhachHang`, `Email`, `TaiKhoan`, `MatKhau`, `SoDienThoai`, `DiaChi`, `RoleID`) VALUES (NULL, '$tenkh', '$email', '$taikhoan', '$pass', '$sdt', '123123', 'U')";
    $connect->exec($sql);
