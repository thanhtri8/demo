...
if(isset($_POST['sub']))
{
    ...
    echo $role='U'  ;
    $sql= "INSERT INTO `khachhang` (`MaKhachHang`, `TenKhachHang`, `Email`, `TaiKhoan`, `MatKhau`, `SoDienThoai`, `DiaChi`, `RoleID`) VALUES (NULL, '$tenkh', 'phuc122@gmail.com', 'phucb', '3333', '0912345678', '123123', 'U')";
    $connect->exec($sql);
